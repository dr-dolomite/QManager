...
| Alerts (unified SMS + email connection alerts, `/monitoring/alerts`), `alert_engine.sh`, `alert_routing.sh`, `monitoring/alerts.sh`, `alert_routing.json`, `use-alerts.ts`, trigger×channel routing/capability matrix | [`docs/features/alerts.md`](docs/features/alerts.md) |
